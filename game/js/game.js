...
var questionnumber=0;
		...
		function answer(e) {
			...
			var question=["2.齲齒的形成有四個影響因素，下列何者不是?",
						  ...
						  "16.牙齒經常與氟化物接觸，可以有哪些功能?",
						  "17.含氟漱口水使用注意事項為何?",
						  "18.下列何為錯誤的口腔觀念:(A)邊看電視、報紙、邊潔牙(B)沒有進食就不用刷牙(C)長期使用漱口藥水潔牙(D)飯後嚼食口香糖潔牙",
			...
			var btn_answer2=["食物的數量","24顆","半年","食物殘渣","28顆","a+b+c+e","大約在出生六個月",
						     "牙齒鄰接表面","每晚睡前","牙冠","要有氟，使用含氟牙膏","牙結石","A+B+F+G","研磨食物",
			...
			var btn_answer3=["清潔牙齒","28顆","一年","牙菌斑","32顆","a+b+c+d","6歲幼稚園大班或國小一年級",
							 ...
							 "A+C+D","A+C+D","A+C+D"];
			var btn_answer4=["食物種類","32顆","兩年","牙結石","52顆","以上皆是","國中一年級青春期","以上皆是","覺得髒就刷","以上皆是","以上皆是",
